 ...
 * Description: The best FB Webhooks integration plugin ever! This plugin integrates the following features: FB Reviews, Automated bots, FB-WordPress posts synchronization and FB Page plugins etc. This plugin also allows developers to use powerful Hooks to connect FB Page comments and messages.
 * Version: 1.9
 * Author: Chun
