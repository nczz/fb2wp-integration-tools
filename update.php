...
class Mxp_Update {
    public static $version_list = array('1.3.4', '1.3.5', '1.3.6', '1.3.7', '1.3.8', '1.3.9', '1.4.0', '1.4.1', '1.4.2', '1.4.3', '1.4.3.1', '1.4.4', '1.4.5', '1.4.6', '1.4.7', '1.4.7.1', '1.4.7.2', '1.4.7.3', '1.4.7.4', '1.4.8', '1.4.9', '1.5.0', '1.5.1', '1.5.2', '1.5.3', '1.5.4', '1.5.5', '1.5.6', '1.5.7', '1.5.7.1', '1.5.8', '1.5.9', '1.5.9.1', '1.6.0', '1.6.0.1', '1.7.0', '1.7.0.1', '1.7.0.4', '1.7.1', '1.7.2', '1.7.3', '1.7.4', '1.7.5', '1.7.6', '1.7.7', '1.7.8', '1.7.9', '1.8.0', '1.8.1', '1.8.2', '1.9', '1.9.1', '1.9.2', '1.9.3', '1.9.4', '1.9.5', '1.9.6', '1.9.7', '1.9.8', '1.9.9');
    ...
    public static function mxp_update_to_v1_8_2() {
        //修正 Facebook 儲存文章按鈕不顯示的問題
        return true;
    }
    public static function mxp_update_to_v1_9() {
        //臉書請求下架、修正相關品牌名稱外掛
        return true;
    }
    public static function mxp_update_to_v1_9_1() {
        //很無奈，名稱有 FB 就是不行，改名！ 歷史時間： 2019/09/20 01:23 AM
        return true;
    }
    public static function mxp_update_to_v1_9_2() {
        //重新啟動專案還會需要經過自動安全性檢查機制
        return true;
    }
    public static function mxp_update_to_v1_9_3() {
        //更新資料編碼
        // 機器人關鍵字
        ...
        if ($default_reply != "") {
            update_option("mxp_messenger_default_reply", base64_encode($default_reply));
        }
        // 文章下方欄位
        $post_footer = get_option("mxp_fb2wp_post_footer", "");
        if ($post_footer != "") {
    ...
    public static function mxp_update_to_v1_9_4() {
        //修正眼花下造成的錯誤警訊
        return true;
    }
    public static function mxp_update_to_v1_9_5() {
        //新增移除 Webhooks 重複資料紀錄的功能
        return true;
    }
    public static function mxp_update_to_v1_9_6() {
        // 更新外掛名稱
        // 修正自動回覆設定頁面功能問題
        return true;
    }
    public static function mxp_update_to_v1_9_7() {
        // 修正寫法
        return true;
    }
    public static function mxp_update_to_v1_9_8() {
        // 更新外掛支援 WordPress 版本與 FB SDK 版本
        return true;
    }
    public static function mxp_update_to_v1_9_9() {
