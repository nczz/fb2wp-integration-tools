...
<div id="fb_plugin" class="container Section">
		...
		(<a href="https://goo.gl/zXU8rH" target="_blank"><?php esc_html_e('How to embed Messenger Messenger Bot with FB2WP (zh-tw)','fb2wp-integration-tools');//參考使用 FB2WP 將臉書 Messenger 聊天機器人加入 WordPress 網站教學?></a>)
		...
		<p><?php esc_html_e('Logged in greeting: ','fb2wp-integration-tools');//Messenger 顧客聊天登入狀態顯示訊息：?>
			<input type="text" name="mxp_fb_messenger_logged_in_greeting" value="<?php echo get_option("mxp_fb_messenger_logged_in_greeting", "你好，歡迎透過訊息聯絡我們！"); ?>" size="40"/><br /><?php esc_html_e('(Maximum 80 characters)','fb2wp-integration-tools');//（最多 80 字元）?>
		</p>
		<p><?php esc_html_e('Logged out greeting: ','fb2wp-integration-tools');//Messenger 顧客聊天登出狀態顯示訊息：?>
			<input type="text" name="mxp_fb_messenger_logged_out_greeting" value="<?php echo get_option("mxp_fb_messenger_logged_out_greeting", "你好，歡迎透過訊息聯絡我們！"); ?>" size="40"/><br /><?php esc_html_e('(Maximum 80 characters)','fb2wp-integration-tools');//（最多 80 字元）?>
		</p>
...
<p><?php esc_html_e('Current version: ','fb2wp-integration-tools');echo Mxp_FB2WP::$version; ?></p>
<p><?php esc_html_e('Contact the developer: ','fb2wp-integration-tools'); ?><a href="https://www.mxp.tw/contact/" target="blank">江弘竣（阿竣）Chun</a></p>
<p><?php esc_html_e('Sponsor the developer: ','fb2wp-integration-tools'); ?><a href="https://goo.gl/XQYSq1" target="blank"><?php esc_html_e('Do you think the plugin helpful? Buy me a cup of coffee!','fb2wp-integration-tools');//覺得有幫助嗎？請作者喝一杯咖啡吧！?></a></p>