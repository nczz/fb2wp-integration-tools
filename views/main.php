...
<div id="fb_plugin" class="container Section">
		...
		<input type="text" name="mxp_fb_functions_section_title" value="<?php echo get_option("mxp_fb_functions_section_title", /* translators: Default block title for Facebook Plugins block. HTML is supported. */esc_attr_e('<h3>Facebook Plugins</h3>', 'fb2wp-integration-tools')); ?>">
